            ...
            <div class="d-flex vh-100">
                <div class="d-flex align-items-center sinEspacio">
                    <div>
                        ...
                        <p class="mb-0 text-light fuenteGrande fuenteGruesa">Desarrollador</p>
    ...
    <div class="contenido mb-5 pb-5">
        <div class="container pt-5 mt-5 text-light">
            ...
            <div class="pt-5 mt-5 mb-5 pb-5">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card mb-3 fondoInvisible" style="max-width: 540px;">
                            <div class="row g-0">
                              <div class="col-md-4">
                                <img class="img-fluid rounded-start" src="img/logo-freelance.jpg" alt="Logo Cumbre Dental">
                              </div>
                              <div class="col-md-8">
                                <div class="card-body ps-3 pe-3 p-0">
                                  <h5 class="card-title fuenteGruesa">Freelancer</h5>
                                  <p class="card-text"><span class="fuenteGruesa colorAzul">Desarrollador Independiente</span> donde desarrollé aplicaciones weby tomé requerimientos técnicos y funcionales. <small class="text-muted">2021 - 2022</small></p>
                                </div>
                              </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card mb-3 fondoInvisible" style="max-width: 540px;">
                            <div class="row g-0">
                              <div class="col-md-4">
                                <img class="img-fluid rounded-start" src="img/logo_cumbre.jpg" alt="Logo Cumbre Dental">
                              </div>
                              <div class="col-md-8">
                                <div class="card-body ps-3 pe-3 p-0">
                    ...
                    <div class="col-lg-4">
                        <div class="card mb-3 fondoInvisible" style="max-width: 540px;">
                            <div class="row g-0">
                              <div class="col-md-4">
                                <img class="img-fluid rounded-start" src="img/logo_sycar.jpg" alt="Logo Grupo Sycar">
                              </div>
                              <div class="col-md-8">
                                <div class="card-body ps-3 pe-3 p-0">
        ...
        <div class="pt-5 mt-5 mb-5 pb-5">
            ...
            <div class="container mt-5 pt-3" style="position: relative;">
                <div class="row">
                    ...
                    <div class="col-lg-6 divSombreado p-0" style="z-index: 1;">
                        <a target="_blank" href="https://www.firmante.cl/">
                            <img class="w-100 imgSobreada" src="img/proyectos/firmante-zoom.png" alt="">
                        </a>
                    </div>
                </div>
        ...
        <div class="pt-5 mt-5 pb-5 fondoTransparente">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="colorAzul fuenteGruesa mb-2">Nombre Completo:</label>
                            <input type="text" class="form-control" placeholder="Tu nombre acá">
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label class="colorAzul fuenteGruesa mb-2">Correo Electrónico:</label>
                                    <input type="text" class="form-control" placeholder="Tu correo acá">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label class="colorAzul fuenteGruesa mb-2">Teléfono / Celular:</label>
                                    <input type="text" class="form-control" placeholder="Tu celular acá">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="colorAzul fuenteGruesa mb-2">Mensaje:</label>
                            <textarea class="form-control" name="" id="" placeholder="Tu mensaje acá"></textarea>
                        </div>
                        <div class="text-end">
                            <button class="btn fondoAzul text-light">Enviar Mensaje</button>
                        </div>
                    </div>
                </div>
            </div>
